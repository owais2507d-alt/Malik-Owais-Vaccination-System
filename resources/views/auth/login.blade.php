...
<body class="bg-gradient-to-br from-slate-50 via-cyan-50 to-blue-50 min-h-screen flex items-center justify-center p-4">
    ...
    <div
        class="bg-white w-full max-w-6xl min-h-[640px] rounded-3xl shadow-2xl border border-slate-100 overflow-hidden grid grid-cols-1 md:grid-cols-12">

        <!-- Left Banner / Sidebar -->
        <div
            class="hidden md:flex md:col-span-5 bg-gradient-to-br from-cyan-700 via-teal-800 to-slate-900 p-10 flex-col justify-between relative overflow-hidden">

            <!-- Background Patterns -->
            <div
                class="absolute inset-0 opacity-10 bg-[radial-gradient(#ffffff_1px,transparent_1px)] [background-size:25px_25px]">
            </div>
            <div
                class="absolute inset-0 bg-[linear-gradient(45deg,#ffffff08_25%,transparent_25%,transparent_50%,#ffffff08_50%,#ffffff08_75%,transparent_75%)] [background-size:60px_60px]">
            </div>
                ...
                <form action="{{ route('login') }}" method="POST" class="space-y-6" id="loginForm">
                    ...
                    <div class="flex items-center justify-between text-sm">
                        ...
                        <a href="{{ route('password.request') }}"
                            class="text-cyan-600 hover:text-cyan-700 font-medium">Forgot Password?</a>
                    </div>
                ...
                <div class="text-center mt-8">
                    <p class="text-slate-500 text-sm">
                        ...
                        <a href="{{ route('register') }}"
                            class="font-semibold text-cyan-600 hover:text-cyan-700 transition-colors">Create Account</a>
                    </p>
                </div>
            </div>
        </div>
